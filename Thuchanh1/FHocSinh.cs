...
namespace Thuchanh1
{
    public partial class FHocSinh : Form
    {
        ...
        {
            HocSinh_class hocsinh = new HocSinh_class(ucThongtin1.txt_ID.Text, ucThongtin1.txt_phone.Text, ucThongtin1.txt_email.Text, ucThongtin1.txt_gioitinh.Text, ucThongtin1.txtFullName.Text,
                         ucThongtin1.txtAddress.Text, ucThongtin1.txtIdentifyNum.Text, ucThongtin1.dtpDoB.Value, float.Parse(ucThongtin1.txt_Diem.Text)); HocSinhDAO.Delete(hocsinh);
        ...
        {
            HocSinh_class hocsinh = new HocSinh_class(ucThongtin1.txt_ID.Text, ucThongtin1.txt_phone.Text, ucThongtin1.txt_email.Text, ucThongtin1.txt_gioitinh.Text, ucThongtin1.txtFullName.Text,
                        ucThongtin1.txtAddress.Text, ucThongtin1.txtIdentifyNum.Text, ucThongtin1.dtpDoB.Value, float.Parse(ucThongtin1.txt_Diem.Text)); HocSinhDAO.Edit(hocsinh);
            Form1_Load(this, EventArgs.Empty);
        }
        ...
        {
            HocSinh_class hocsinh = new HocSinh_class(ucThongtin1.txt_ID.Text, ucThongtin1.txt_phone.Text, ucThongtin1.txt_email.Text, ucThongtin1.txt_gioitinh.Text, ucThongtin1.txtFullName.Text,
              ucThongtin1.txtAddress.Text, ucThongtin1.txtIdentifyNum.Text, ucThongtin1.dtpDoB.Value, float.Parse(ucThongtin1.txt_Diem.Text));
