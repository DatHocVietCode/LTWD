    ...
    public partial class FHocSinh : Form
    {
        ...
        private void Gv1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                ucThongtin1.mtxt_phone.Text = row.Cells[7].Value.ToString();
        ...
        {
            if (!HocSinhDAO.Check_input_hocsinh(ucThongtin1.txt_ID.Text, ucThongtin1.mtxt_phone.Text,
            ...
            HocSinh_class hocsinh = new HocSinh_class(ucThongtin1.txt_ID.Text, ucThongtin1.mtxt_phone.Text, 
                        ucThongtin1.txt_email.Text, ucThongtin1.cb_gioitinh.SelectedItem.ToString(), ucThongtin1.txtFullName.Text,
