...
namespace Thuchanh1
{
    ...
    {
        public static bool Check_input_hocsinh(string t1, string t2, string t3, string t4, string t5, string t6, string t7, string t8)
        {
        ...
        public static DataTable AddHocSinh(HocSinh_class hocsinh)
           {
                ...
                if (!(Check_Information(hocsinh) && Check_ID(hocsinh.ID1,"HocSinh")))
                {
        ...
        public static DataTable EditHocSinh(HocSinh_class hocsinh)
        {
             ...
             sqlStr = string.Format("UPDATE HocSinh SET CMND = '{1}', Ten = '{2}', Sex = '{3}', DoB = '{4}', DiaChi = '{5}', Email = '{6}', Phone = '{7}', Diem = '{8}'" +
